...
export const projects = [
  {
    ...
    en: {
      title: "Investor Sentiment & Stock Price Prediction",
      category: "MARKET INTELLIGENCE · FINANCIAL MACHINE LEARNING",
      subtitle:
        "Can alternative text signals improve market prediction beyond historical prices?",
      role: "Co-Author · ML Researcher · Data Analyst",
      projectType: "Market Intelligence · Financial Machine Learning · NLP",
      timeline: "Timeline to be added",
      outcome: "Sentiment features improved accuracy and reduced false positives.",
      proofPoints: [
        "S&P 500 market data + financial news",
        "FinBERT sentiment as a market feature",
        "Random Forest / LightGBM / XGBoost, with and without sentiment",
    ...
    ko: {
      title: "투자자 심리와 주가 예측",
      category: "마켓 인텔리전스 · 금융 머신러닝",
      subtitle: "대안 텍스트 신호는 가격 이력을 넘어 시장 예측을 개선할 수 있을까?",
      role: "공동저자 · ML 연구원 · 데이터 애널리스트",
      projectType: "마켓 인텔리전스 · 금융 머신러닝 · NLP",
      timeline: "기간: 추후 기재",
      outcome: "감성 피처가 정확도를 높이고 오탐을 줄였습니다.",
      proofPoints: [
        "S&P 500 시장 데이터 + 금융 뉴스",
        "시장 피처로 활용한 FinBERT 감성",
        "감성 포함/미포함 RF · LightGBM · XGBoost 비교",
        "정확도 상승과 오탐 감소",
      ],
      snapshot: [
        { label: "역할", value: "공동저자" },
  ...
  },
  {
    ...
    links: { github: "https://github.com/worldstar0722" },
    en: {
      title: "Measuring Attention, Engagement, and Strategic Return",
      category: "ALTERNATIVE DATA · ROI ANALYTICS",
      subtitle: "Does visibility actually translate into value?",
      role: "First Author · Researcher · Data Analyst",
      projectType: "Alternative Data · ROI Analytics · Research",
      timeline: "Timeline to be added",
      outcome:
        "Found that the visibility a $7M spot buys does not necessarily translate into positive reception.",
      proofPoints: [
        "64,230 tweets across 59 Super Bowl LX brands",
        "ROI Efficiency · Engagement Efficiency · Sustained Ratio · Net Sentiment",
        "Six metrics into one composite decision model",
        "R² < 0.05 vs. Ad Meter — visibility ≠ strategic return",
      ],
      snapshot: [
    ...
    ko: {
      title: "주목도·참여도, 그리고 전략적 회수율의 측정",
      category: "대안 데이터 · ROI 애널리틱스",
      subtitle: "노출은 정말 가치로 이어질까?",
      role: "제1저자 · 연구원 · 데이터 애널리스트",
      projectType: "대안 데이터 · ROI 애널리틱스 · 연구",
      timeline: "기간: 추후 기재",
      outcome: "700만 달러가 사들인 노출이 곧 긍정적 반응으로 이어지지는 않는다는 것을 확인했습니다.",
      proofPoints: [
        "슈퍼볼 LX 59개 브랜드의 트윗 64,230건",
        "ROI 효율 · 참여 효율 · 지속 비율 · 순감성",
        "6개 지표를 하나의 복합 의사결정 모델로",
        "Ad Meter 대비 R² < 0.05 — 노출 ≠ 전략적 성과",
      ],
      snapshot: [
        { label: "역할", value: "제1저자" },
  ...
  },
  {
    ...
    en: {
      ...
      category: "PROPTECH · LOCATION INTELLIGENCE",
      subtitle:
        "Using accessibility and infrastructure data to identify patterns in residential investment potential.",
      role: "Sole Researcher · GIS Analyst",
      projectType: "PropTech · Location Intelligence · Spatial Analysis",
    ...
    ko: {
      ...
      category: "프롭테크 · 로케이션 인텔리전스",
      subtitle:
        "접근성과 인프라 데이터로 주거 지역의 투자 잠재력 패턴을 읽습니다.",
      role: "단독 연구자 · GIS 분석가",
      projectType: "프롭테크 · 로케이션 인텔리전스 · 공간 분석",
