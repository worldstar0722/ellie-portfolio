...
export const projects = [
  ...
  },
  {
    ...
    en: {
      ...
      category: "RESEARCH · MARKETING ROI · NLP",
      subtitle: "Measuring the return on a $7M ad spot: visibility bought vs. reception earned.",
      role: "First Author · Researcher · Data Analyst",
      projectType: "Marketing ROI · Advertising Analytics · Research",
      timeline: "Timeline to be added",
      outcome:
    ...
    ko: {
      title: "슈퍼볼 광고 애널리틱스",
      category: "리서치 · 마케팅 ROI · NLP",
      subtitle: "700만 달러 광고의 회수율을 측정합니다 — 산 노출과 실제로 얻은 반응.",
      role: "제1저자 · 연구원 · 데이터 애널리스트",
      projectType: "마케팅 ROI · 광고 애널리틱스 · 연구",
      timeline: "기간: 추후 기재",
      outcome: "700만 달러가 사들인 노출이 곧 긍정적 반응으로 이어지지는 않는다는 것을 확인했습니다.",
      proofPoints: [
        "30초당 광고비 700만 달러",
        "6개 지표의 Winning Score 모델",
        "트윗 64,230건 · LX 브랜드 59개",
